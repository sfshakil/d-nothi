...
{
    public partial class UCAnumatiPraptaUserLis : UserControl
    {
        ...
        public UCAnumatiPraptaUserLis(IUserService userService, IGuardFileService<GuardFileModel, GuardFileModel.Record> guardFileService, IGuardFileService<GuardFileCategory, GuardFileCategory.Record> guardFileCategoryService)
        {
