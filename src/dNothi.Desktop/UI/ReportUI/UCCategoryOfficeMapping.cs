...
{
    public partial class UCCategoryOfficeMapping : UserControl
    {
        ...
        public UCCategoryOfficeMapping(IUserService userService, IReportPermissionServices reportPermissionServices)
        {
