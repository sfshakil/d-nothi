...
{
    public class NothivuktoPotroParser : INothivuktoPotroParser
    {
        public NothivuktoPotroResponse ParseMessage(string messageString)
        {
            try
            {
                NothivuktoPotroResponse messageObject = JsonConvert.DeserializeObject<NothivuktoPotroResponse>(messageString);
