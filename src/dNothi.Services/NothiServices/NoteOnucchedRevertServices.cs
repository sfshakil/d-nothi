    ...
    public class NoteOnucchedRevertServices : INoteOnucchedRevertServices
    {
        public NoteOnucchedRevertResPonse GetNoteOnucchedRevert(DakUserParam dakUserParam, NothiListRecordsDTO nothiListRecords, NoteSaveDTO newnotedata)
        {
            try
            {
                ...
                request.AddParameter("onucched", "{\"note_no\":\"" + newnotedata.note_id + "\",\"note_subject\":\"" + newnotedata.note_subject + "\",\"nothi_subject\":\""+ nothiListRecords .subject+ "\",\"nothi_id\":\"" + nothiListRecords.id + "\",\"nothi_office\":\"" + dakUserParam.office_id + "\",\"nothi_office_name\":\"" + nothiListRecords.office_name + "\",\"note_id\":\"" + newnotedata.note_id + "\"}");
