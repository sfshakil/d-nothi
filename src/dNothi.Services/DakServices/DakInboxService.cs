...
namespace dNothi.Services.DakServices
{
    public class DakInboxService : IDakInboxServices
    {
        ...
        {
            DakItem dakItemDB = _dakItem.Table.FirstOrDefault(a => a.page == dakListUserParam.page && a.is_dak_inbox_Search == true && a.office_id == dakListUserParam.office_id && a.designation_id == dakListUserParam.designation_id && a.searchParameter==searchParam);
            ...
            else
            {
                ...
                dakItem.is_dak_inbox_Search = true;
        ...
        public DakListInboxResponse GetDakInbox(DakUserParam dakListUserParam, string searchParam)
        {
            ...
            if (!dNothi.Utility.InternetConnection.Check())
            {
                var dakList = _dakItem.Table.FirstOrDefault(a => a.page == dakListUserParam.page && a.is_dak_inbox_Search == true && a.office_id == dakListUserParam.office_id && a.designation_id == dakListUserParam.designation_id && a.searchParameter==@searchParam);
            ...
            try
            {
                ...
                var dakInboxResponseJson = dakInboxResponse.Content;
                SaveOrUpdateDakOutBoxListJsonResponse(dakListUserParam, dakInboxResponseJson, searchParam);
                dakListInboxResponse = JsonConvert.DeserializeObject<DakListInboxResponse>(dakInboxResponseJson);
                return dakListInboxResponse;
            }
            catch (Exception ex)
