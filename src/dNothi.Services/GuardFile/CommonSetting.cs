   ...
   public   class CommonSetting
    {
        ...
        public static string GetEndPoint(int actionLink)
        {
            ...
            if (actionLink == 1)
            {
                endPoint = DefaultAPIConfiguration.GuardFileCategoryList;
            }
            if (actionLink == 2)
            {
                endPoint = DefaultAPIConfiguration.GuardFileList;
            }
            if (actionLink == 3)
            {
                endPoint = DefaultAPIConfiguration.GuardFileCreateEdit;
            }
            if (actionLink == 4)
            {
                 
                endPoint = DefaultAPIConfiguration.GuardFileDelete;
            }
            if (actionLink == 5)
            {
