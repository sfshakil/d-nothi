   ...
   public interface IGuardFileService<ResponseData, InputParam> where ResponseData : class where InputParam : class 
    {
        ...
        GuardFileCategory GetLocalGuarFileCategoryData(DakUserParam obj, int actionLink);
        GuardFileModel GetLocalGuarFileData(DakUserParam userParam, int actionLink);
